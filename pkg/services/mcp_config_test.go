...
func TestMCPConfigService_Get_FiltersToolsByInstalledApps(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Contains(t, enabledToolNames(resp.UserTools), "query")
	assert.Contains(t, enabledToolNames(resp.UserTools), "validate")
	assert.Contains(t, enabledToolNames(resp.UserTools), "sample")
	...
	assert.NotContains(t, enabledToolNames(resp.UserTools), "list_glossary")
	assert.NotContains(t, enabledToolNames(resp.UserTools), "get_glossary_sql")
...
func TestMCPConfigService_Get_WithOnlyAIDataLiaisonInstalled_ExcludesCoreApprovedQueryTools(t *testing.T) {
	...
	assert.Contains(t, enabledToolNames(resp.DeveloperTools), "list_glossary")
	assert.Contains(t, enabledToolNames(resp.DeveloperTools), "get_glossary_sql")
	assert.Contains(t, enabledToolNames(resp.DeveloperTools), "get_query_history")
	...
	assert.Contains(t, enabledToolNames(resp.UserTools), "list_glossary")
	assert.Contains(t, enabledToolNames(resp.UserTools), "get_glossary_sql")
	assert.NotContains(t, enabledToolNames(resp.UserTools), "get_context")
}
