...
var AllToolsOrdered = []ToolSpec{
	...
	{Name: "list_approved_queries", Description: "List approved SQL queries"},
	{Name: "execute_approved_query", Description: "Execute an approved query by ID"},
	{Name: "suggest_approved_query", Description: "Suggest a reusable parameterized query for approval"},
	{Name: "suggest_query_update", Description: "Suggest an update to an existing approved query for review"},
	...
	{Name: "create_approved_query", Description: "Create a new approved query directly (no review required)"},
	{Name: "update_approved_query", Description: "Update an existing approved query directly (no review required)"},
	{Name: "delete_approved_query", Description: "Delete an approved query"},
