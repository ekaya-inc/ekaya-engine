...
var ToolRegistry = []ToolDefinition{
	...
	{Name: "update_project_knowledge", Description: "Create or update writable domain facts (terminology, business rules, enumerations, conventions); project_overview is read-only here", ToolGroup: ToolGroupDeveloper},
	{Name: "delete_project_knowledge", Description: "Remove writable domain facts by fact_id; project_overview is read-only here", ToolGroup: ToolGroupDeveloper},
