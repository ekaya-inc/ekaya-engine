...
var ToolRegistry = []ToolDefinition{
	...
	{Name: "get_column_metadata", Description: "Get current ontology metadata for a column (description, enum_values, entity, role, schema info)", ToolGroup: ToolGroupDeveloper},
