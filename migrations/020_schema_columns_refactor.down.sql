-- 020_schema_columns_refactor.down.sql
-- Rollback: restore engine_schema_columns with original schema including removed fields
--
-- WARNING: This is a destructive rollback. All column data will be lost.

-- Drop FK constraints from engine_entity_relationships
...
-- Recreate original engine_schema_columns with all fields
...
-- Recreate original engine_schema_relationships
