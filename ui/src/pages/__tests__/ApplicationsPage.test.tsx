...
describe('ApplicationsPage', () => {
  ...
  it('renders Install buttons for installable apps when not installed', () => {
    ...
    // AI Data Liaison and MCP Tunnel have Install buttons (AI Agents tile is temporarily hidden)
  ...
  it('renders Installed badge and Configure button when AI Data Liaison is installed', () => {
    ...
    // MCP Tunnel still has an Install button (AI Agents tile is temporarily hidden)
    const installButtons = screen.getAllByRole('button', { name: 'Install' });
