...
interface MCPLogoProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/**
 * MCP (Model Context Protocol) Official Logo
 * Source: https://github.com/modelcontextprotocol/modelcontextprotocol
 *
 * Uses currentColor for stroke, so it adapts to light/dark themes automatically.
 */
export default function MCPLogo({ size = 24, className, ...props }: MCPLogoProps) {
  return (
    <svg
      width={size}
      height={size}
