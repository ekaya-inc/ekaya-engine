...
- **MCP Server** = blue: Datasource
- **Ontology Forge** = purple: Schema, Pre-Approved Queries, Ontology Extraction, Ontology Questions, Project Knowledge, Enrichment, Relationships
- **AI Data Liaison** = green: Audit Log
